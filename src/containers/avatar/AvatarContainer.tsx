    ...
    <div className="container mx-auto space-y-8 px-4 py-8">
      ...
      >
        <div className="flex items-center gap-3">
          <h1 className="bg-gradient-to-r from-chart-1 to-primary bg-clip-text font-bold text-4xl text-transparent">
            Avatar VTuber
          </h1>
          <Badge
            variant="secondary"
        ...
        >
          ...
          {connected && (
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
              ...
              <CardContent>
                {models.length === 0 ? (
                  <p className="py-4 text-muted-foreground text-center text-xs">
                ...
                <div className="space-y-3">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="max-w-[180px] truncate text-foreground text-xs font-medium">
